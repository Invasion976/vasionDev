...
Config.QBCoreSHAREDOBJECT = "QBCore:GetObject" 	-- Change your getshared object event here, in case you are using anti-cheat

Config.format = {
	['money'] = 'USD',			-- This is the format of the currency, so that your currency sign appears correctly [Examples: BRL, USD]
...
Config.companies = {
	["trucker_1"] = {															-- ID
		['name'] = "Port",														-- Name
		['coordinate'] = {1208.7689208984,-3114.9829101562,5.5403342247009},	-- Coordinate to open the menu
		['garage_coordinate'] = {												-- Garage coordinates, where the trucks will spawn (coordinates composed of x, y, z, h)
		...
		['load_coordinate'] = {												-- Trailer coordinates, where the trailers will spawn (coordinates composed of x, y, z, h)
...
Config.contracts = {
	['cancel_contract'] = 167,					-- Key to cancel the active job (167 = F6) [Hold key 2 seconds]
	['cooldown'] = 1, 							-- Cooldown time (in minutes) to generate a new contract
	['price_per_km_min'] = 840, --1400				-- Minimum price per kilometer of the contract
	['price_per_km_max'] = 1200, --2000				-- Maximum price per kilometer of the contract
	['shipping_multiplier'] = 1.2,				-- Multiplier applied when generating FREIGHT loads
	['probability_be_urgent_load'] = 10,	    -- The urgent load is generated randomly, here you can configure the probability (%)
	['max_active_contracts'] = 60,				-- Maximum of contracts that can be active, this means that when generating a contact that exceeds this number, the oldest contract will be deleted
	['trucks'] = {
        -- List of trucks that are generated in contracts
		"phantom"--"man","daf","vnl780"
	},
	['cargo'] = {
		--[[ 
		...
		{ carga = "armytanker", name = "Army fuel tank", def = {3,0,0}},
		{ carga = "armytanker", name = "Army water supply", def = {0,0,0}},
		{ carga = "armytanker", name = "Army Corrosive Materials Tank", def = {6,0,1}},
		{ carga = "armytanker", name = "Army flammable gas tank", def = {2,0,0}},
		{ carga = "armytanker", name = "Army toxic gas tank", def = {5,0,0}},
		{ carga = "armytanker", name = "Army secret materials", def = {0,0,1}},

		--{ carga = "liquid1", name = "Potassium hydroxide", def = {6,0,0}},
		--{ carga = "liquid1", name = "Nitrogen", def = {2,0,1}},
		--{ carga = "liquid1", name = "Potassium chloride", def = {5,0,0}},
		--{ carga = "liquid1", name = "Poison", def = {5,0,0}},
		--{ carga = "liquid1", name = "Pesticide", def = {5,0,0}},

		{ carga = "armytrailer", name = "empty army trailer", def = {0,0,0}},

		{ carga = "armytrailer2", name = "Heavy machinery transport", def = {0,1,1}},
		{ carga = "armytrailer2", name = "Tunneling machine transport", def = {0,1,1}},
		
		{ carga = "docktrailer", name = "Furniture transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Refrigerator transport", def = {0,1,0}},
		{ carga = "docktrailer", name = "Brick transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Transport of imported products", def = {0,0,1}},
		{ carga = "docktrailer", name = "Transport of plastics", def = {0,0,0}},
		{ carga = "docktrailer", name = "Clothing transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Chair transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Appliance transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Transport of cleaning supplies", def = {0,0,0}},
		{ carga = "docktrailer", name = "Refined timber transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Stone transport", def = {0,0,0}},
		{ carga = "docktrailer", name = "Transport of jewels", def = {0,1,1}},
		{ carga = "docktrailer", name = "Glass transport", def = {0,1,0}},
		{ carga = "docktrailer", name = "Ammo transport", def = {1,0,0}},
		
		{ carga = "freighttrailer", name = "Trailer empty", def = {0,0,0}},

		{ carga = "tr2", name = "Car trailer empty", def = {0,0,0}},
		
		{ carga = "trailers4", name = "Naval articles trailer", def = {0,0,0}},
		{ carga = "trailers4", name = "Boat trailer", def = {0,1,1}},
		
		{ carga = "tr4", name = "Stork", def = {0,1,1}},
		
		{ carga = "tvtrailer", name = "Transport of materials for shows", def = {0,0,1}},
		{ carga = "tvtrailer", name = "Transport of event materials", def = {0,1,1}},
		
		{ carga = "tanker", name = "Fuel tank with additives", def = {3,0,0}},
		{ carga = "tanker2", name = "Common fuel tank", def = {3,0,0}},
		{ carga = "tanker2", name = "Kerosene tank", def = {3,0,0}},
		{ carga = "tanker2", name = "Oil tank", def = {3,0,0}},
		
		{ carga = "docktrailer", name = "Transport of exotic materials", def = {0,1,1}},
		{ carga = "docktrailer", name = "Transport of rare materials", def = {0,1,1}},
		{ carga = "docktrailer", name = "Transport of armaments", def = {0,0,1}},
		
		{ carga = "trailerlogs", name = "Log transportation", def = {0,0,0}},
		
		{ carga = "trailers", name = "Transport of construction materials", def = {0,0,0}},
		{ carga = "trailers", name = "Rubber transport", def = {0,0,0}},
		{ carga = "trailers", name = "Appliance transportation", def = {0,1,0}},
		{ carga = "trailers", name = "Transport of vaccines", def = {0,1,0}},
		{ carga = "trailers", name = "Transport of explosives", def = {1,1,0}},
		{ carga = "trailers", name = "Sawdust transport", def = {0,0,0}},

		{ carga = "trailers2", name = "Grape transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Pork transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Transport of beef", def = {0,0,0}},
		{ carga = "trailers2", name = "Carrot transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Potato transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Milk transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Transport of canned goods", def = {0,0,0}},
		{ carga = "trailers2", name = "Frozen meat transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Bean transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Vinegar transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Lemonade transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Bottled water transport", def = {0,0,0}},
		{ carga = "trailers2", name = "Cheese transport", def = {0,0,0}},

		{ carga = "trailers3", name = "Tile transport", def = {0,0,0}},
		{ carga = "trailers3", name = "Rail transport", def = {0,0,0}},
		{ carga = "trailers3", name = "Transport of used packaging", def = {0,0,0}},
		{ carga = "trailers3", name = "Floor plate transport", def = {0,0,0}},
		{ carga = "trailers3", name = "Ceramic transport", def = {0,1,0}},
		{ carga = "trailers3", name = "Scrap transport", def = {0,0,0}},

		{ carga = "trailers4", name = "Transport of fireworks", def = {1,1,0}},
		{ carga = "trailers4", name = "Transport of explosives", def = {1,1,0}},
		{ carga = "trailers4", name = "Dynamite transport", def = {1,1,0}},
		{ carga = "trailers4", name = "White phosphorus transport", def = {4,1,0}},

		--{ carga = "heli1", name = "Helicopter Transport", def = {0,1,1}},
		--{ carga = "military1", name = "Army vehicle transport", def = {0,1,1}},
	}
}
...
Config.drivers = {
	...
	['price_per_km_min'] = 180,	--300				-- Minimum starting price per KM of the driver (at the end of each delivery)
	['price_per_km_max'] = 360,	--600				-- Maximum initial price per KM of the driver (at the end of each delivery)
	['price_min'] = 10000,						-- Minimum initial price of the driver (at the end of each delivery)
	['price_max'] = 11000,						-- Maximum initial price of the driver (at the end of each delivery)
	['percentage_bonus_skills'] = 5,		-- This is the cost in % that each skill will increase in the driver's salary. That is, for each ability he has, the starting price will increase by 5%
	['names'] = {
...
Config.works = {
	...
	['initial_value_min'] = 10000,			-- Minimum initial contract profit
	['initial_value_max'] = 12000,			-- Maximum initial contract profit
	['percentage_bonus_skills'] = 7,	-- Percentage that will be generated from profit for each skill that the driver has
	['generates_money_offline'] = false 		-- true: drivers will generate money all the time / false: drivers will generate money only if the owner is online
}

Config.sale_multiplier = 0.7	-- Value you receive when selling the used truck
...
Config.repair_value = { -- Value to repair 1% of each part (Example: if 40% of the part is damaged, the value to repair will be multiplied by 40)
	['engine'] = 250,
	['body'] = 150,
	['transmission'] = 200,
	['wheels'] = 100
