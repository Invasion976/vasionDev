...
Config.Locations = {
    ["checking"] = vector4(307.98, -596.13, 43.46, 0.0),
    ["duty"] = {
    ...
    ["armory"] = {
        [1] = vector4(310.27, -603.02, 43.29, 90.654),
    ...
    ["beds"] = {
        [1] = {coords = vector4(357.42, -594.47, 43.31, 340), taken = false, model = 1631638868, location = "pillbox"},
        [2] = {coords = vector4(354.39, -592.66, 43.31, 340), taken = false, model = 1631638868, location = "pillbox"},
        [3] = {coords = vector4(350.82, -591.67, 43.31, 340), taken = false, model = 1631638868, location = "pillbox"},
        [4] = {coords = vector4(347.00, -590.61, 43.31, 340), taken = false, model = 1631638868, location = "pillbox"},
